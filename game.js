...
// ============================================================================
// 8. АВТОЗАПУСК САУНДТРЕКА (AUTOPLAY & FIRST INTERACTION UNLOCK)
// ============================================================================
// 1. Попытка мгновенного запуска музыки при загрузке страницы
sound.startMusic();

// 2. Если строгая политика браузера заблокировала автоплей до жеста пользователя —
// активируем саундтрек при самом первом клике, тапе или свайпе по экрану
...
['pointerdown', 'touchstart', 'click', 'keydown'].forEach(evtType => {
    window.addEventListener(evtType, unlockAudioOnUserAction, { once: true, passive: true });
});
